		...
		<form id="user-profile" method="POST" action="" enctype="multipart/form-data"> 
			...
			<div class="form-row">
				<div class="form-group col-md-6 col-sm-6">
					...
					<select id="inputState" class="form-control select" name="gender" placeholder="Select your gender" value="<?php echo $gender; ?>">
				...
				<div class="form-group col-md-6 col-sm-6">
					...
					<div class="form-row">
						<div class="col-md-3 col-sm-3">
							<select id="mobcode" class="form-control select" name="mobcode" value="">
						...
						<div class="col-md-9 col-sm-9">
							...
							?>
							" name="mob_no" id="mob" placeholder="Enter your phone number">
						</div>
					</div>
				</div>
			...
			<div class="form-row">
				<div class="form-group col-md-6 col-sm-6">
					...
					<input type="text" class="form-control" name="address1" id="inputEmail4" placeholder="Enter your address" value="<?php echo $add1; ?>">
				</div>
				<div class="form-group col-md-6 col-sm-6">
					<label for="inputEmail4">Address Line 2</label>
					<input type="text" class="form-control" value="<?php echo $add2; ?>" name="address2" id="inputEmail4" placeholder="Enter your address">
				</div>
				<div class="form-group col-md-6 col-sm-6">
				...
				<div class="form-group col-md-6 col-sm-6">
					...
					<input type="text" class="form-control" id="inputEmail4" value="<?php echo $state; ?>" name="state" placeholder="Enter your state">
				</div>
				<div class="form-group col-md-6 col-sm-6">
					<label for="inputEmail4">ZipCode <sup>*</sup></label>
					<input type="text" class="form-control" id="inputEmail4" value="<?php echo $zip; ?>" name="zipcode" placeholder="Enter your zipcode">
				</div>
				<div class="form-group col-md-6 col-sm-6">
					<label for="inputState">Country <sup>*</sup></label>
					<select id="inputState" class="form-control select" placeholder="Select your gender" name="country">
