						...
						<div class="card-body">
							...
							<form method="POST" action="#" id="sign-up">
								...
								<div class="form-group">
									...
									<input id="email" type="text" class="form-control" id="email" name="email" value="" required autofocus placeholder="Enter your email address">
								</div>
			...
			$.ajax({
                        ...
                        success: function(data) {
							if(data == "2"){
								...
								$('#wait').html('Email Id not in a correct format!');
							}
							else{
